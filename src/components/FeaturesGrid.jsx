...
const allFeatures = [
  ...
  {
    title: 'جساب مدد التجديد من الشطب',
    desc: 'جساب المدد القانونية للدعاوي المشطوبة وإدراجها في الاجندة بشكل تلقائي.',
    icon: faCalendarDays,
    color: 'text-purple-600',
    bgColor: 'bg-purple-50'
  },
  {
    title: 'جساب مدد التعجيل من الوقف',
    desc: 'جساب المدد القانونية للدعاوي الموقوفة تعليقبا او جزائيا وإدراجها في الاجندة بشكل تلقائي.',
    icon: faCalendarPlus,
