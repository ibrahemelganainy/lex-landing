...
const plans = [
  { 
    ...
    prices: [
      ...
      { duration: 'أربع سنوات', amount: '5,700', original: '8,000' }
    ],
    features: ['كل المميزات المتقدمة', 'نسخ سحابي مجدول آلياً', 'تخصيص كامل للصلاحيات', 'دعم فني وتحديثات مجانية']
  },
  { 
    name: 'Pro', 
    users: '10 مستخدمين', 
    ...
    features: ['كل المميزات المتقدمة', 'نسخ سحابي ومحلي مجدول آلياً', 'تخصيص كامل للصلاحيات', 'دعم فني VIP وأولوية في التحديثات']
  },
  { 
    name: 'Enterprise', 
    users: 'غير محدود', 
